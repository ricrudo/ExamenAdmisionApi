...
from ownModules.formatData import formatCedula, formatName
from ownModules.getCandidates import getCandidates, activateCandidate, deactivateCadidate, getActiveCandidate, setGradeCandidate, removeJuryAwaiting, getGrades
